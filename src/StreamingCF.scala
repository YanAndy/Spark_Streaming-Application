...
class StreamingCF (
  ...
  private val numUsers = 1000
  private val numProducts = 1000
  private val kValues = 100
  ...
  def update(data: RDD[MatrixEntry], timeUnit: String): CollabFilterModel = {
    ...
    if (blockMat == null) {
      var tmp = new Array[((Int, Int), (Array[Array[Double]]))](1000)
      for (t <- 0 to 999) {
        tmp(t) = (((t / 100).toInt, t % 100), Array.fill(10)(Array.fill(10)(0.0)))
      }
...
object CFApp{
  def main(args:Array[String]){
    ...
    val trainingData = ssc.sparkContext.textFile("/Users/andy/Downloads/Kaggle/u_data.txt")
